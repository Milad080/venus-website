function DotedInfrastructure() {
  return (
    <div className="bg-black h-[510px] max-md:mt-6 relative md:h-screen xl:h-[750px]">
      <img
        src="images/contactusgif.gif"
        alt="contactusgif"
...
export default DotedInfrastructure;
